...
### 6. Budget Estimation
The cost estimate for the target architecture was created with [AWS Pricing Calculator](https://calculator.aws/#/estimate?id=a306a7de1d836e86cd98fdd1980002edbde0cefb). The [cost estimate file](/images/2-Proposal/estimate_cost.pdf) can be downloaded for details.
