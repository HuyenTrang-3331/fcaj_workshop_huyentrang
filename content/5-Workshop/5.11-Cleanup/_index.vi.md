...
![RDS final_alerts evidence](/images/5-Workshop/5.11-Cleanup/10-rds-final-alerts-evidence.png)
...
![Terminate backend and worker instances](/images/5-Workshop/5.11-Cleanup/01-ec2-terminate-backend-worker.png)
...
![Delete ALB action](/images/5-Workshop/5.11-Cleanup/02-alb-delete-menu.png)

![Confirm ALB deletion](/images/5-Workshop/5.11-Cleanup/03-alb-delete-confirm.png)

![Delete target group](/images/5-Workshop/5.11-Cleanup/04-target-group-delete-menu.png)
...
![Main SQS queue deleted](/images/5-Workshop/5.11-Cleanup/05-sqs-main-queue-deleted.png)

![DLQ deleted](/images/5-Workshop/5.11-Cleanup/06-sqs-dlq-deleted.png)
...
![S3 data bucket content before deletion](/images/5-Workshop/5.11-Cleanup/07-s3-data-bucket-contents.png)

![S3 delete objects status](/images/5-Workshop/5.11-Cleanup/08-s3-delete-objects-status.png)

![S3 buckets deleted](/images/5-Workshop/5.11-Cleanup/09-s3-buckets-deleted.png)
...
![Delete RDS with final snapshot](/images/5-Workshop/5.11-Cleanup/11-rds-delete-final-snapshot.png)

![RDS delete confirmation](/images/5-Workshop/5.11-Cleanup/12-rds-delete-confirmation.png)

![RDS deleted](/images/5-Workshop/5.11-Cleanup/13-rds-deleted.png)
...
![Secrets Manager list before deletion](/images/5-Workshop/5.11-Cleanup/14-secrets-manager-list.png)

![Secret metadata before delete](/images/5-Workshop/5.11-Cleanup/15-secret-before-delete.png)

![Secret scheduled for deletion](/images/5-Workshop/5.11-Cleanup/16-secret-scheduled-deletion.png)
...
![CloudFront distributions disabled but under Pro plan](/images/5-Workshop/5.11-Cleanup/17-cloudfront-distributions-disabled-pro-plan.png)
...
![Only default behavior remains](/images/5-Workshop/5.11-Cleanup/18-cloudfront-default-behavior-only.png)

*Caption:* Ordered behaviors đã được giảm còn required `Default (*)`. Default
behavior không thể xóa độc lập.

![CloudFront OAC retained](/images/5-Workshop/5.11-Cleanup/19-cloudfront-oac-retained.png)

*Caption:* OAC vẫn được giữ lại vì distribution còn tồn tại và vẫn reference
origin/OAC.

![CloudFront-created WAF protection pack](/images/5-Workshop/5.11-Cleanup/20-waf-created-by-cloudfront-pro-plan.png)
...
![IAM Identity Center users with MFA](/images/5-Workshop/5.11-Cleanup/21-iam-identity-center-users-mfa.png)

![IAM Identity Center groups before deletion](/images/5-Workshop/5.11-Cleanup/22-iam-identity-center-groups-before-delete.png)

![IAM Identity Center groups deleted](/images/5-Workshop/5.11-Cleanup/23-iam-identity-center-groups-deleted.png)
...
![CloudWatch log groups before deletion](/images/5-Workshop/5.11-Cleanup/24-cloudwatch-log-groups-before-delete.png)

![CloudWatch alarms before deletion](/images/5-Workshop/5.11-Cleanup/25-cloudwatch-alarms-before-delete.png)

![Delete CloudWatch log groups](/images/5-Workshop/5.11-Cleanup/26-cloudwatch-delete-log-groups-dialog.png)
...
![Delete VPC endpoint](/images/5-Workshop/5.11-Cleanup/27-vpc-endpoint-delete.png)

![Delete NAT Gateway](/images/5-Workshop/5.11-Cleanup/28-nat-gateway-delete.png)

![Release Elastic IP](/images/5-Workshop/5.11-Cleanup/29-release-elastic-ip.png)
...
![Delete route table](/images/5-Workshop/5.11-Cleanup/30-route-table-delete.png)

![Route table cleanup complete](/images/5-Workshop/5.11-Cleanup/31-route-table-cleanup-complete.png)

![VPC subnets before deletion](/images/5-Workshop/5.11-Cleanup/32-vpc-subnets-before-delete.png)

![Delete security group](/images/5-Workshop/5.11-Cleanup/33-security-group-delete.png)

![Internet Gateway before deletion](/images/5-Workshop/5.11-Cleanup/34-internet-gateway-before-delete.png)

![Delete Internet Gateway](/images/5-Workshop/5.11-Cleanup/35-internet-gateway-delete.png)

![VPC deletion complete](/images/5-Workshop/5.11-Cleanup/36-vpc-delete-complete.png)
